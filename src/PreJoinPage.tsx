...
import {
  DEFAULT_LIVEKIT_TOKEN,
  DEFAULT_LIVEKIT_URL,
} from './livekitDefaults';
...
export const PreJoinPage = ({
  ...
  const [url, setUrl] = useState(DEFAULT_LIVEKIT_URL);
  const [token, setToken] = useState(DEFAULT_LIVEKIT_TOKEN);
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={{ color: colors.text, ...styles.helperText }}>
        Token must be generated by your backend. Do not put the LiveKit API
      ...
      <Button
        title="Reset Values"
        onPress={() => {
          saveValues(DEFAULT_LIVEKIT_URL, DEFAULT_LIVEKIT_TOKEN);
          setUrl(DEFAULT_LIVEKIT_URL);
          setToken(DEFAULT_LIVEKIT_TOKEN);
        }}
      />
    </View>
  );
